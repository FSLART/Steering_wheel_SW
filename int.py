...
from can_receiver import CANSignalReceiver, signal_values, message_signals , watched_ids , send_message
...
title_1 = ctk.CTkLabel(rect_1, text="Temp INV ", font=("Noto Sans Bold ", 18))  # Create a Label
...
title_2 = ctk.CTkLabel(rect_2, text="Temp Motor", font=("Noto Sans Bold ", 18))  # Create a Label
...
title_3 = ctk.CTkLabel(rect_3, text="BPS", font=("Noto Sans Bold ", 18))  # Create a Label
...
def update_data():
    ...
    if soc_hv_level != "ERR":
        soc_HV_per.configure(text=str(int(soc_hv_level * 100)) + '%')  # Update SoC LV percentage
        soc_HV_bar.set(soc_hv_level)  # Update SoC HV progress bar
    if soc_lv_level != "ERR":
        soc_LV_per.configure(text=str(int(soc_lv_level * 100)) + '%')  # Update SoC HV percentage
...
def open_calibration_window():
    ...
    calibration_label = ctk.CTkLabel(calibration_window, text="LEVEL: N/A", font=("Noto Sans Bold", 28), text_color="white")
